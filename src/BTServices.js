      ...
      <div className="flex flex-col md:flex-row gap-5 items-start px-12 pr-14 py-14 pt-20">
        <div className="flex-[2] lg:flex-[2] order-last animate-slide-in">
          <div className="">
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis et porro architecto neque autem amet, eligendi est laboriosam natus ex, delectus nisi ea ducimus dolores quibusdam ipsum eos quos provident.</p>
          </div>
        </div>
