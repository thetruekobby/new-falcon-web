          ...
          <div className="flex-[1] lg:flex-1 order-last md:order-first animate-slide-in">
            ...
            <div className="space-y-6 text-lg">
              <p>
                ...
                development company known for its technical expertise and
                commitment to excellence. We bring creativity and innovation to
                every web project we undertake.
              </p>
              <p>
                Our mission is to democratize web development by providing
                user-friendly and powerful software solutions that enable anyone
                to create stunning websites and web applications.
              </p>
            </div>
          </div>
